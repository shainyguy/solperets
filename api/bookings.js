  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const { data, error } = await supabase.from('bookings_v2').insert({
        ...
        customer_email: b.customer_email || null, table_number: b.table_number || null,
        seats: b.seats || null, event_type: b.event_type || null,
        event_date: b.event_date, event_time: b.event_time,
        guests_count: b.guests_count, package_type: b.package_type || null,
        extra_services: b.extra_services || [], total_estimate: b.total_estimate || 0,
