...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <div className="flex items-center gap-3">
          <a href="tel:+79257677778" className="hidden md:flex items-center gap-2 text-white/70 hover:text-orange-400 transition-colors text-sm">
            <Phone size={16} />
        ...
        {mobileOpen && (
          ...
          >
            <div className="px-4 py-4 flex flex-col gap-1">
              ...
              <button onClick={() => { setMobileOpen(false); setTableModalOpen(true); }}
    ...
    <TableBookingModal isOpen={tableModalOpen} onClose={() => setTableModalOpen(false)} />
    </>
  );
}
